...
func TestGetTeams(t *testing.T) {
	...
	require.Len(t, *res, 1)
	require.Equal(t, 33, (*res)[0].Team.ID)
	require.Equal(t, "Manchester United", (*res)[0].Team.Name)
	require.Equal(t, "MUN", (*res)[0].Team.Code)
	require.Equal(t, "England", (*res)[0].Team.Country)
	require.Equal(t, 1878, (*res)[0].Team.Founded)
	require.False(t, (*res)[0].Team.National)
	require.Equal(t, "https://media.api-sports.io/football/teams/33.png", (*res)[0].Team.Logo)
	require.Equal(t, 556, (*res)[0].Venue.ID)
	require.Equal(t, "Old Trafford", (*res)[0].Venue.Name)
	require.Equal(t, "Sir Matt Busby Way", (*res)[0].Venue.Address)
	require.Equal(t, "Manchester", (*res)[0].Venue.City)
	require.Equal(t, 76212, (*res)[0].Venue.Capacity)
	require.Equal(t, "grass", (*res)[0].Venue.Surface)
	require.Equal(t, "https://media.api-sports.io/football/venues/556.png", (*res)[0].Venue.Image)
}
...
func TestGetTeamSeasons(t *testing.T) {
	...
	require.Equal(t, 2010, (*res)[0])
	require.Equal(t, 2021, (*res)[11])
}
...
func TestGetTeamStatistics(t *testing.T) {
	...
	require.Equal(t, 39, (*res).League.ID)
	require.Equal(t, "Premier League", (*res).League.Name)
	require.Equal(t, "England", (*res).League.Country)
	require.Equal(t, "https://media.api-sports.io/football/leagues/39.png", (*res).League.Logo)
	require.Equal(t, "https://media.api-sports.io/flags/gb-eng.svg", (*res).League.Flag)
	require.Equal(t, 2019, (*res).League.Season)
	require.Equal(t, 33, (*res).Team.ID)
	require.Equal(t, "Manchester United", (*res).Team.Name)
	require.Equal(t, "https://media.api-sports.io/football/teams/33.png", (*res).Team.Logo)
	require.Equal(t, "WDLDWLDLDWLWDDWWDLWWLWLLDWWDWDWWWWDWDW", (*res).Form)
	require.Equal(t, 19, (*res).Fixtures.Played.Home)
	require.Equal(t, 19, (*res).Fixtures.Played.Away)
	require.Equal(t, 38, (*res).Fixtures.Played.Total)
	require.Equal(t, 10, (*res).Fixtures.Wins.Home)
	require.Equal(t, 8, (*res).Fixtures.Wins.Away)
	require.Equal(t, 18, (*res).Fixtures.Wins.Total)
	require.Equal(t, 7, (*res).Fixtures.Draws.Home)
	require.Equal(t, 5, (*res).Fixtures.Draws.Away)
	require.Equal(t, 12, (*res).Fixtures.Draws.Total)
	require.Equal(t, 2, (*res).Fixtures.Loses.Home)
	require.Equal(t, 6, (*res).Fixtures.Loses.Away)
	require.Equal(t, 8, (*res).Fixtures.Loses.Total)
	require.Equal(t, 40, (*res).Goals.For.Total.Home)
	require.Equal(t, 26, (*res).Goals.For.Total.Away)
	require.Equal(t, 66, (*res).Goals.For.Total.Total)
	require.Equal(t, "2.1", (*res).Goals.For.Average.Home)
	require.Equal(t, "1.4", (*res).Goals.For.Average.Away)
	require.Equal(t, "1.7", (*res).Goals.For.Average.Total)
}
