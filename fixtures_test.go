...
func TestGetFixtures(t *testing.T) {
	...
	require.Nil(t, resp.Response[0].Score.Fulltime.Home)
	require.Nil(t, resp.Response[0].Score.Fulltime.Away)
	require.Nil(t, resp.Response[0].Score.Extratime.Home)
	require.Nil(t, resp.Response[0].Score.Extratime.Away)
	require.Nil(t, resp.Response[0].Score.Penalty.Home)
	require.Nil(t, resp.Response[0].Score.Penalty.Away)
}
...
func TestClient_GetFixturesEvents(t *testing.T) {
	...
	require.Nil(t, resp.Response[0].Assist.ID)
	require.Nil(t, resp.Response[0].Assist.Name)
	require.Equal(t, "Goal", *resp.Response[0].Type)
	require.Equal(t, "Normal Goal", *resp.Response[0].Detail)
	require.Nil(t, resp.Response[0].Comments)
	...
	require.Nil(t, resp.Response[1].Assist.ID)
	require.Nil(t, resp.Response[1].Assist.Name)
	require.Equal(t, "Card", *resp.Response[1].Type)
	require.Equal(t, "Yellow Card", *resp.Response[1].Detail)
	require.Nil(t, resp.Response[1].Comments)
	...
	require.Nil(t, resp.Response[2].Assist.ID)
	require.Nil(t, resp.Response[2].Assist.Name)
	require.Equal(t, "Card", *resp.Response[2].Type)
	require.Equal(t, "Yellow Card", *resp.Response[2].Detail)
	require.Nil(t, resp.Response[2].Comments)
	...
	require.Nil(t, resp.Response[3].Assist.ID)
	require.Nil(t, resp.Response[3].Assist.Name)
	require.Equal(t, "Card", *resp.Response[3].Type)
	require.Equal(t, "Yellow Card", *resp.Response[3].Detail)
	require.Nil(t, resp.Response[3].Comments)
}
...
func TestClient_GetFixturesLineups(t *testing.T) {
	...
	require.Nil(t, resp.Response[0].Substitutes[7].Player.Grid)
	...
	require.Nil(t, resp.Response[1].Substitutes[6].Player.Grid)
...
func TestClient_GetFixturesPlayers(t *testing.T) {
	...
	require.Nil(t, resp.Response[0].Players[0].Statistics[0].Offsides)
	...
	require.Nil(t, resp.Response[0].Players[0].Statistics[0].Goals.Total)
	require.Equal(t, 1, *resp.Response[0].Players[0].Statistics[0].Goals.Conceded)
	require.Nil(t, resp.Response[0].Players[0].Statistics[0].Goals.Assists)
	...
	require.Nil(t, resp.Response[0].Players[0].Statistics[0].Tackles.Total)
	...
	require.Nil(t, resp.Response[0].Players[0].Statistics[0].Duels.Total)
	require.Nil(t, resp.Response[0].Players[0].Statistics[0].Duels.Won)
	...
	require.Nil(t, resp.Response[0].Players[0].Statistics[0].Dribbles.Past)
	...
	require.Nil(t, resp.Response[0].Players[0].Statistics[0].Penalty.Won)
	require.Nil(t, resp.Response[0].Players[0].Statistics[0].Penalty.Commited)
