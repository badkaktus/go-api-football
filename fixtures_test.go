...
func TestGetFixtures(t *testing.T) {
	...
	require.Equal(t, 239625, (*resp)[0].Fixture.ID)
	require.Equal(t, "UTC", (*resp)[0].Fixture.Timezone)
	require.Equal(t, "2020-02-06 14:00:00", (*resp)[0].Fixture.Date.Format("2006-01-02 15:04:05"))
	require.Equal(t, 1580997600, (*resp)[0].Fixture.Timestamp)
	require.Equal(t, 1580997600, (*resp)[0].Fixture.Periods.First)
	require.Equal(t, "Stade Municipal", (*resp)[0].Fixture.Venue.Name)
	require.Equal(t, "Oued Zem", (*resp)[0].Fixture.Venue.City)
	require.Equal(t, "Halftime", (*resp)[0].Fixture.Status.Long)
	require.Equal(t, "HT", (*resp)[0].Fixture.Status.Short)
	require.Equal(t, 45, (*resp)[0].Fixture.Status.Elapsed)
	require.Equal(t, 200, (*resp)[0].League.ID)
	require.Equal(t, "Botola Pro", (*resp)[0].League.Name)
	require.Equal(t, "Morocco", (*resp)[0].League.Country)
	require.Equal(t, "https://media.api-sports.io/football/leagues/115.png", (*resp)[0].League.Logo)
	require.Equal(t, "https://media.api-sports.io/flags/ma.svg", (*resp)[0].League.Flag)
	require.Equal(t, 2019, (*resp)[0].League.Season)
	require.Equal(t, "Regular Season - 14", (*resp)[0].League.Round)
	require.Equal(t, 967, (*resp)[0].Teams.Home.ID)
	require.Equal(t, "Rapide Oued ZEM", (*resp)[0].Teams.Home.Name)
	require.Equal(t, "https://media.api-sports.io/football/teams/967.png", (*resp)[0].Teams.Home.Logo)
	require.Equal(t, false, (*resp)[0].Teams.Home.Winner)
	require.Equal(t, 968, (*resp)[0].Teams.Away.ID)
	require.Equal(t, "Wydad AC", (*resp)[0].Teams.Away.Name)
	require.Equal(t, "https://media.api-sports.io/football/teams/968.png", (*resp)[0].Teams.Away.Logo)
	require.Equal(t, true, (*resp)[0].Teams.Away.Winner)
	require.Equal(t, 0, (*resp)[0].Goals.Home)
	require.Equal(t, 1, (*resp)[0].Goals.Away)
	require.Equal(t, 0, (*resp)[0].Score.Halftime.Home)
	require.Equal(t, 1, (*resp)[0].Score.Halftime.Away)
	require.Equal(t, 0, (*resp)[0].Score.Fulltime.Home)
	require.Equal(t, 0, (*resp)[0].Score.Fulltime.Away)
	require.Equal(t, 0, (*resp)[0].Score.Extratime.Home)
	require.Equal(t, 0, (*resp)[0].Score.Extratime.Away)
	require.Equal(t, 0, (*resp)[0].Score.Penalty.Home)
	require.Equal(t, 0, (*resp)[0].Score.Penalty.Away)
}
...
func TestGetHead2Head(t *testing.T) {
	...
	require.Equal(t, 1, len(*resp))
	require.Equal(t, 157201, (*resp)[0].Fixture.ID)
	require.Equal(t, "Kevin Friend, England", (*resp)[0].Fixture.Referee)
	require.Equal(t, "UTC", (*resp)[0].Fixture.Timezone)
	require.Equal(t, "2019-12-26 17:30:00", (*resp)[0].Fixture.Date.Format("2006-01-02 15:04:05"))
	require.Equal(t, 1577381400, (*resp)[0].Fixture.Timestamp)
	require.Equal(t, 1577381400, (*resp)[0].Fixture.Periods.First)
	require.Equal(t, 1577385000, (*resp)[0].Fixture.Periods.Second)
	require.Equal(t, "Old Trafford", (*resp)[0].Fixture.Venue.Name)
	require.Equal(t, "Manchester", (*resp)[0].Fixture.Venue.City)
	require.Equal(t, "Match Finished", (*resp)[0].Fixture.Status.Long)
	require.Equal(t, "FT", (*resp)[0].Fixture.Status.Short)
	require.Equal(t, 90, (*resp)[0].Fixture.Status.Elapsed)
	require.Equal(t, 39, (*resp)[0].League.ID)
	require.Equal(t, "Premier League", (*resp)[0].League.Name)
	require.Equal(t, "England", (*resp)[0].League.Country)
	require.Equal(t, "https://media.api-sports.io/football/leagues/2.png", (*resp)[0].League.Logo)
	require.Equal(t, "https://media.api-sports.io/flags/gb.svg", (*resp)[0].League.Flag)
	require.Equal(t, 2019, (*resp)[0].League.Season)
	require.Equal(t, "Regular Season - 19", (*resp)[0].League.Round)
	require.Equal(t, 33, (*resp)[0].Teams.Home.ID)
	require.Equal(t, "Manchester United", (*resp)[0].Teams.Home.Name)
	require.Equal(t, "https://media.api-sports.io/football/teams/33.png", (*resp)[0].Teams.Home.Logo)
	require.Equal(t, true, (*resp)[0].Teams.Home.Winner)
	require.Equal(t, 34, (*resp)[0].Teams.Away.ID)
	require.Equal(t, "Newcastle", (*resp)[0].Teams.Away.Name)
	require.Equal(t, "https://media.api-sports.io/football/teams/34.png", (*resp)[0].Teams.Away.Logo)
	require.Equal(t, false, (*resp)[0].Teams.Away.Winner)
	require.Equal(t, 4, (*resp)[0].Goals.Home)
	require.Equal(t, 1, (*resp)[0].Goals.Away)
	require.Equal(t, 3, (*resp)[0].Score.Halftime.Home)
	require.Equal(t, 1, (*resp)[0].Score.Halftime.Away)
	require.Equal(t, 4, (*resp)[0].Score.Fulltime.Home)
	require.Equal(t, 1, (*resp)[0].Score.Fulltime.Away)
	require.Equal(t, 0, (*resp)[0].Score.Extratime.Home)
	require.Equal(t, 0, (*resp)[0].Score.Extratime.Away)
	require.Equal(t, 0, (*resp)[0].Score.Penalty.Home)
	require.Equal(t, 0, (*resp)[0].Score.Penalty.Away)
...
func TestGetFixturesStatistics(t *testing.T) {
	...
	//for _, stat := range (*resp)[0].Statistics {
	//	fmt.Printf("%T\n", stat.Value)
	//}
	require.NoError(t, err)

	require.Equal(t, 1, len(*resp))
	require.Equal(t, 463, (*resp)[0].Team.ID)
	require.Equal(t, "Aldosivi", (*resp)[0].Team.Name)
	require.Equal(t, "https://media.api-sports.io/football/teams/463.png", (*resp)[0].Team.Logo)
	require.Equal(t, float64(3), (*resp)[0].Statistics[0].Value)
	require.Equal(t, float64(2), (*resp)[0].Statistics[1].Value)
	require.Equal(t, float64(9), (*resp)[0].Statistics[2].Value)
	require.Equal(t, float64(4), (*resp)[0].Statistics[3].Value)
	require.Equal(t, float64(4), (*resp)[0].Statistics[4].Value)
	require.Equal(t, float64(5), (*resp)[0].Statistics[5].Value)
	require.Equal(t, float64(22), (*resp)[0].Statistics[6].Value)
	require.Equal(t, float64(3), (*resp)[0].Statistics[7].Value)
	require.Equal(t, float64(1), (*resp)[0].Statistics[8].Value)
	require.Equal(t, "32%", (*resp)[0].Statistics[9].Value)
	require.Equal(t, float64(5), (*resp)[0].Statistics[10].Value)
	require.Equal(t, float64(1), (*resp)[0].Statistics[11].Value)
	require.Nil(t, (*resp)[0].Statistics[12].Value)
	require.Equal(t, float64(242), (*resp)[0].Statistics[13].Value)
	require.Equal(t, float64(121), (*resp)[0].Statistics[14].Value)
	require.Nil(t, (*resp)[0].Statistics[15].Value)
}
...
func TestGetFixturesEvents(t *testing.T) {
	...
	require.Equal(t, 18, len(*resp))
	require.Equal(t, 25, (*resp)[0].Time.Elapsed)
	require.Equal(t, "Aldosivi", (*resp)[0].Team.Name)
	require.Equal(t, 463, (*resp)[0].Team.ID)
	require.Equal(t, "https://media.api-sports.io/football/teams/463.png", (*resp)[0].Team.Logo)
	require.Equal(t, "F. Andrada", (*resp)[0].Player.Name)
	require.Equal(t, 6126, (*resp)[0].Player.ID)
	require.Equal(t, 0, (*resp)[0].Assist.ID)
	require.Equal(t, "", (*resp)[0].Assist.Name)
	require.Equal(t, "Goal", (*resp)[0].Type)
	require.Equal(t, "Normal Goal", (*resp)[0].Detail)
	require.Equal(t, "", (*resp)[0].Comments)
	require.Equal(t, 33, (*resp)[1].Time.Elapsed)
	require.Equal(t, "Defensa Y Justicia", (*resp)[1].Team.Name)
	require.Equal(t, 442, (*resp)[1].Team.ID)
	require.Equal(t, "Julio González", (*resp)[1].Player.Name)
	require.Equal(t, 5936, (*resp)[1].Player.ID)
	require.Equal(t, 0, (*resp)[1].Assist.ID)
	require.Equal(t, "", (*resp)[1].Assist.Name)
	require.Equal(t, "Card", (*resp)[1].Type)
	require.Equal(t, "Yellow Card", (*resp)[1].Detail)
	require.Equal(t, "", (*resp)[1].Comments)
	require.Equal(t, 33, (*resp)[2].Time.Elapsed)
	require.Equal(t, "Aldosivi", (*resp)[2].Team.Name)
	require.Equal(t, 463, (*resp)[2].Team.ID)
	require.Equal(t, "Federico Andrada", (*resp)[2].Player.Name)
	require.Equal(t, 6126, (*resp)[2].Player.ID)
	require.Equal(t, 0, (*resp)[2].Assist.ID)
	require.Equal(t, "", (*resp)[2].Assist.Name)
	require.Equal(t, "Card", (*resp)[2].Type)
	require.Equal(t, "Yellow Card", (*resp)[2].Detail)
	require.Equal(t, "", (*resp)[2].Comments)
	require.Equal(t, 36, (*resp)[3].Time.Elapsed)
	require.Equal(t, "Defensa Y Justicia", (*resp)[3].Team.Name)
	require.Equal(t, 442, (*resp)[3].Team.ID)
	require.Equal(t, "Diego Rodríguez", (*resp)[3].Player.Name)
	require.Equal(t, 5931, (*resp)[3].Player.ID)
	require.Equal(t, 0, (*resp)[3].Assist.ID)
	require.Equal(t, "", (*resp)[3].Assist.Name)
	require.Equal(t, "Card", (*resp)[3].Type)
	require.Equal(t, "Yellow Card", (*resp)[3].Detail)
	require.Equal(t, "", (*resp)[3].Comments)
}
...
func TestGetFixturesLineups(t *testing.T) {
	...
	require.Equal(t, 50, (*resp)[0].Team.ID)
	require.Equal(t, "Manchester City", (*resp)[0].Team.Name)
	require.Equal(t, "https://media.api-sports.io/football/teams/50.png", (*resp)[0].Team.Logo)
	require.Equal(t, "4-3-3", (*resp)[0].Formation)
	require.Equal(t, 617, (*resp)[0].StartXI[0].Player.ID)
	require.Equal(t, "Ederson", (*resp)[0].StartXI[0].Player.Name)
	require.Equal(t, 31, (*resp)[0].StartXI[0].Player.Number)
	require.Equal(t, "G", (*resp)[0].StartXI[0].Player.Pos)
	require.Equal(t, "1:1", (*resp)[0].StartXI[0].Player.Grid)
	require.Equal(t, 627, (*resp)[0].StartXI[1].Player.ID)
	require.Equal(t, "Kyle Walker", (*resp)[0].StartXI[1].Player.Name)
	require.Equal(t, 2, (*resp)[0].StartXI[1].Player.Number)
	require.Equal(t, "D", (*resp)[0].StartXI[1].Player.Pos)
	require.Equal(t, "2:4", (*resp)[0].StartXI[1].Player.Grid)
	require.Equal(t, 636, (*resp)[0].Substitutes[7].Player.ID)
	require.Equal(t, "Bernardo Silva", (*resp)[0].Substitutes[7].Player.Name)
	require.Equal(t, 20, (*resp)[0].Substitutes[7].Player.Number)
	require.Equal(t, "M", (*resp)[0].Substitutes[7].Player.Pos)
	require.Equal(t, "", (*resp)[0].Substitutes[7].Player.Grid)
	require.Equal(t, "5badff", (*resp)[0].Team.Colors.Player.Primary)
	require.Equal(t, "ffffff", (*resp)[0].Team.Colors.Player.Number)
	require.Equal(t, "99ff99", (*resp)[0].Team.Colors.Player.Border)
	require.Equal(t, "99ff99", (*resp)[0].Team.Colors.Goalkeeper.Primary)
	require.Equal(t, "000000", (*resp)[0].Team.Colors.Goalkeeper.Number)
	require.Equal(t, "99ff99", (*resp)[0].Team.Colors.Goalkeeper.Border)
	require.Equal(t, 45, (*resp)[1].Team.ID)
	require.Equal(t, "Everton", (*resp)[1].Team.Name)
	require.Equal(t, "https://media.api-sports.io/football/teams/45.png", (*resp)[1].Team.Logo)
	require.Equal(t, "4-3-1-2", (*resp)[1].Formation)
	require.Equal(t, 2932, (*resp)[1].StartXI[0].Player.ID)
	require.Equal(t, "Jordan Pickford", (*resp)[1].StartXI[0].Player.Name)
	require.Equal(t, 1, (*resp)[1].StartXI[0].Player.Number)
	require.Equal(t, "G", (*resp)[1].StartXI[0].Player.Pos)
	require.Equal(t, "1:1", (*resp)[1].StartXI[0].Player.Grid)
	require.Equal(t, 19150, (*resp)[1].StartXI[1].Player.ID)
	require.Equal(t, "Mason Holgate", (*resp)[1].StartXI[1].Player.Name)
	require.Equal(t, 4, (*resp)[1].StartXI[1].Player.Number)
	require.Equal(t, "D", (*resp)[1].StartXI[1].Player.Pos)
	require.Equal(t, "2:4", (*resp)[1].StartXI[1].Player.Grid)
	require.Equal(t, 1455, (*resp)[1].Substitutes[6].Player.ID)
	require.Equal(t, "Alex Iwobi", (*resp)[1].Substitutes[6].Player.Name)
	require.Equal(t, 17, (*resp)[1].Substitutes[6].Player.Number)
	require.Equal(t, "F", (*resp)[1].Substitutes[6].Player.Pos)
	require.Equal(t, "", (*resp)[1].Substitutes[6].Player.Grid)
	require.Equal(t, "070707", (*resp)[1].Team.Colors.Player.Primary)
	require.Equal(t, "ffffff", (*resp)[1].Team.Colors.Player.Number)
	require.Equal(t, "66ff00", (*resp)[1].Team.Colors.Player.Border)
	require.Equal(t, "66ff00", (*resp)[1].Team.Colors.Goalkeeper.Primary)
	require.Equal(t, "000000", (*resp)[1].Team.Colors.Goalkeeper.Number)
	require.Equal(t, "66ff00", (*resp)[1].Team.Colors.Goalkeeper.Border)
}
...
func TestGetFixturesPlayers(t *testing.T) {
	...
	require.Equal(t, 1, len(*resp))
	require.Equal(t, 2284, (*resp)[0].Team.ID)
	require.Equal(t, "Monarcas", (*resp)[0].Team.Name)
	require.Equal(t, "https://media.api-sports.io/football/teams/2284.png", (*resp)[0].Team.Logo)
	require.Equal(t, "2020-01-13 16:12:12", (*resp)[0].Team.Update.Format("2006-01-02 15:04:05"))
	require.Equal(t, 35931, (*resp)[0].Players[0].Player.ID)
	require.Equal(t, "Sebastián Sosa", (*resp)[0].Players[0].Player.Name)
	require.Equal(t, "https://media.api-sports.io/football/players/35931.png", (*resp)[0].Players[0].Player.Photo)
	require.Equal(t, 90, (*resp)[0].Players[0].Statistics[0].Games.Minutes)
	require.Equal(t, 13, (*resp)[0].Players[0].Statistics[0].Games.Number)
	require.Equal(t, "G", (*resp)[0].Players[0].Statistics[0].Games.Position)
	require.Equal(t, "6.3", (*resp)[0].Players[0].Statistics[0].Games.Rating)
	require.Equal(t, false, (*resp)[0].Players[0].Statistics[0].Games.Captain)
	require.Equal(t, false, (*resp)[0].Players[0].Statistics[0].Games.Substitute)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Offsides)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Shots.Total)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Shots.On)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Goals.Total)
	require.Equal(t, 1, (*resp)[0].Players[0].Statistics[0].Goals.Conceded)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Goals.Assists)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Goals.Saves)
	require.Equal(t, 17, (*resp)[0].Players[0].Statistics[0].Passes.Total)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Passes.Key)
	require.Equal(t, "68%", (*resp)[0].Players[0].Statistics[0].Passes.Accuracy)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Tackles.Total)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Tackles.Blocks)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Tackles.Interceptions)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Duels.Total)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Duels.Won)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Dribbles.Attempts)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Dribbles.Success)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Dribbles.Past)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Fouls.Drawn)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Fouls.Committed)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Cards.Yellow)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Cards.Red)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Penalty.Won)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Penalty.Commited)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Penalty.Scored)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Penalty.Missed)
	require.Equal(t, 0, (*resp)[0].Players[0].Statistics[0].Penalty.Saved)
}
