...
func TestGetTransfers(t *testing.T) {
	...
	require.Len(t, *res, 1)
	require.Equal(t, 35845, (*res)[0].Player.ID)
	require.Equal(t, "Hernán Darío Burbano", (*res)[0].Player.Name)
	require.Equal(t, "2020-02-06 00:08:15", (*res)[0].Update.Format("2006-01-02 15:04:05"))
	require.Equal(t, 8, len((*res)[0].Transfers))
	require.Equal(t, "2019-07-15", (*res)[0].Transfers[0].Date)
	require.Equal(t, "Free", (*res)[0].Transfers[0].Type)
	require.Equal(t, 2283, (*res)[0].Transfers[0].Teams.In.ID)
	require.Equal(t, "Atlas", (*res)[0].Transfers[0].Teams.In.Name)
	require.Equal(t, "https://media.api-sports.io/football/teams/2283.png", (*res)[0].Transfers[0].Teams.In.Logo)
	require.Equal(t, 2283, (*res)[0].Transfers[0].Teams.Out.ID)
	require.Equal(t, "Atlas", (*res)[0].Transfers[0].Teams.Out.Name)
	require.Equal(t, "https://media.api-sports.io/football/teams/2283.png", (*res)[0].Transfers[0].Teams.Out.Logo)
	require.Equal(t, "2020-01-01", (*res)[0].Transfers[7].Date)
	require.Equal(t, "", (*res)[0].Transfers[7].Type)
	require.Equal(t, 1470, (*res)[0].Transfers[7].Teams.In.ID)
	require.Equal(t, "Cucuta", (*res)[0].Transfers[7].Teams.In.Name)
	require.Equal(t, "https://media.api-sports.io/football/teams/1470.png", (*res)[0].Transfers[7].Teams.In.Logo)
	require.Equal(t, 463, (*res)[0].Transfers[7].Teams.Out.ID)
	require.Equal(t, "Aldosivi", (*res)[0].Transfers[7].Teams.Out.Name)
	require.Equal(t, "https://media.api-sports.io/football/teams/463.png", (*res)[0].Transfers[7].Teams.Out.Logo)
}
