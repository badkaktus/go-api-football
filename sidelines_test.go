...
func TestClient_GetSidelined(t *testing.T) {
	...
	require.Len(t, res.Response, 27)
	require.Equal(t, "Suspended", res.Response[0].Type)
	require.Equal(t, "2020-02-26", res.Response[0].Start)
	require.Equal(t, "2020-03-01", res.Response[0].End)
